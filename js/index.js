...
/** Función que permite enviar correo con el formulario diligenciado - Registro.html */

const $form = document.querySelector('#formulario');
const $buttonMailto = document.querySelector('#correo-enviado');
...
async function handleSubmit(event) {
  ...
  //$buttonMailto.setAttribute('href', `mailto:dalopezm11@gmail.com?subject= nombre: ${form.get('nombre')}, descripcion: ${form.get('descripcion')}&body=${form.get('nombre')} \n correo:  ${form.get('correo')} \n  ${form.get('celular')} \n  ${form.get('ciudad')} \n  ${form.get('direccion')} \n  ${form.get('descripcion')}  ${form.get('marca')} \n  ${form.get('modelo')}`);
  //$buttonMailto.click();
};
